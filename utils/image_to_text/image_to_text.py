...
async def get_text_from_url(image_url: str, session: aiohttp.ClientSession, api_key: str = 'helloworld'):
    ...
    try:
        ...
        if result.get("IsErroredOnProcessing"):
            ...
            if "helloworld" in api_key.lower():
                print("The default demo key could be rate-limited. Please get your own free key at https://ocr.space/ocrapi")
